...
# // NOTE:::USER NAME AND HOME DIRECTORY NEED TO BE 'developer' IN ORDER TO WORK CORRECTLY.
...
#Configure the JAVA_HOME environment with one jdk
...
#Configure the GRADLE_HOME environment
export GRADLE_HOME=/usr/bin/gradle 
export PATH="$PATH:GRADLE_HOME/bin"

#For CLI builds, define ANDROID_SDK_ROOT
export ANDROID_SDK_ROOT=/home/developer/Android/Sdk

#Configure ccache for AOSP
export USE_CCACHE=1
export CCACHE_DIR=/home/developer/AOSP/.ccache
